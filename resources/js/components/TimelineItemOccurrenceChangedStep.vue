    ...
    export default {
        ...
        computed: {
            formattedDescription() {
                if (!this.data.oldStep) {
                    return 'Movido para a etapa ' + this.data.newStap.name + '.';
                }
                if (!this.data.newStep) {
                    return 'Removido da etapa ' + this.data.oldStep.name + ' para nenhuma etapa.';
                }
                return 'Movido da etapa ' + this.data.oldStep.name + ' para a etapa ' + this.data.newStep.name + '.';
            },
            formattedDate() {
